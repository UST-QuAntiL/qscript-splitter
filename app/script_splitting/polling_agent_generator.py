...
def generate_polling_agent(parameters, return_values):
    ...
    for inputParameter in parameters:
        load_data_str += '\n'
        load_data_str += '                    if variables.get("' + inputParameter + '").get("type") in ["String", "Integer", "Float", "Boolean"]:\n'
    ...
    for outputParameter in return_values:
        ...
        outputHandler += '                        body["variables"]["' + outputParameter + '"] = {"value": ' + outputParameter + ', "type": "Float"}\n'
